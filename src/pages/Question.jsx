  ...
  <Card sx={{ mb: 2, borderRadius: 3, bgcolor: '#ECF7FF' }}>
    <CardContent>
      <Box sx={{ display: 'flex', gap: 2 }}>
        ...
        <Box sx={{ flex: 1 }}>
          <Typography variant="body2" sx={{ mb: 1, color: '#000000' }}><strong>Câu hỏi: Câu hỏi: Hãy kể tên một vài nguyên tắc thiết kế UI/UX mà bạn biết và giải thích tại sao chúng lại quan trọng.</strong></Typography>
          <Typography variant="body2" color="textSecondary">
          Tính nhất quán: Giúp người dùng dễ dàng nhận diện và tương tác với sản phẩm.
          Đơn giản: Giúp người dùng tập trung vào nhiệm vụ chính.
          Hiển thị trực quan: Sử dụng hình ảnh, biểu tượng để truyền đạt thông tin một cách hiệu quả.
          Phản hồi: Cho người dùng biết rằng hành động của họ đã được thực hiện.
          </Typography>
        </Box>
