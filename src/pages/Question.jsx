            ...
            <div className="question-content">
              <div className="question-text">
                <p className="question-title">
                  <strong>
                    Câu hỏi: Hãy kể tên một vài nguyên tắc thiết kế UI/UX mà bạn
                    biết và giải thích tại sao chúng lại quan trọng.
                  </strong>
                </p>
                <p className="question-answer">
                  Tính nhất quán: Giúp người dùng dễ dàng nhận diện và tương tác
                  với sản phẩm. Đơn giản: Giúp người dùng tập trung vào nhiệm vụ
                  chính. Hiển thị trực quan: Sử dụng hình ảnh, biểu tượng để
                  truyền đạt thông tin một cách hiệu quả. Phản hồi: Cho người
                  dùng biết rằng hành động của họ đã được thực hiện.
                </p>
              </div>
