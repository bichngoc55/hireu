...
import AddExperienceModal from "./AddExp.jsx";
      ...
      <Box sx={{ width: "50%" }}>
        ...
        <Paper sx={{ mb: 2, p: 2 }}>
          ...
          <Typography color="textSecondary" fontSize="small" sx={{ mb: 2 }}>
            Giới thiệu những thành tựu của bản để thu hút nhiều lượt xem hồ sơ
            và kết nối
          </Typography>
        ...
        <Paper sx={{ mb: 2, p: 2 }}>
          ...
          <Typography color="textSecondary" fontSize="small" sx={{ mb: 2 }}>
            Thể hiện khả năng của bạn với những cơ hội mới - 50% nhà tuyển dụng
            dựa vào dữ liệu kỹ năng để tìm kiếm ứng viên phù hợp.
          </Typography>
